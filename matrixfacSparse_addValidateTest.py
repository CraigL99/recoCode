...
sparseDataTest = T.vector('sparseData', dtype=theano.config.floatX)
rowIndTest = T.vector('rowInd', dtype='int32')  # symbolic var for row indices
colIndTest = T.vector('colInd', dtype='int32')  # symbolic var for col indices
